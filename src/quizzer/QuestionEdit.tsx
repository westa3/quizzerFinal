...
import { Question } from "../interfaces/question"; //used to have "QuestionType" in the curly brackets along with Question
...
export const QuestionEdit = ({
    ...
    lastIndex: number,
    question: Question,
    editQuestion: (questioId: number, newQuestion: Question) => void,
                        ...
                        <div className="type_form">
                            <Form.Group controlId="questionTypeFormId">
                                ...
                                <Form.Select
                                    ...
                                    value={question.type}
                                    onChange={switchMulti} //used to be "handleSwitch" in the brackets
                                >
                                    <option
                                        data-testid={
